...
export default function Footer() {
  return (
    <footer className="bg-Button h-auto flex flex-col justify-center items-center w-full sm:px-8 md:px-16 lg:px-[100px] py-7 md:py-5">
      <div className="w-full max-w-[1240px] h-auto flex flex-col gap-[48px]">
        <div className="w-full h-auto flex flex-col lg:flex-row justify-between gap-7 lg:gap-[48px]">
          ...
          <div className="flex flex-col gap-[50px] w-full lg:w-[30%]">
            ...
            <ul className="text-[16px] font-medium text-black flex flex-col justify-between h-full">
              <li>
                <Link
                  href="/"
                  className="text-gray-700 font-medium hover:text-[#B88E2F]"
                >
                  Home
                </Link>
              </li>
